...
import { AlertCircle, CheckCircle2, FileCheck2, FileText, FileUp, GraduationCap, Phone, Send, User, Users, X } from 'lucide-react';
...
const ViewClientModal = ({ clientData, isOpen, onClose, onSuccess }) => {
  ...
  const counselorLabel = clientData?.assigned_counselor_name || 'Unassigned';
